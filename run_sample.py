...
if __name__ == '__main__':
    ...
    #######################修改代码######################
    os.makedirs(args.cam_out_aug_dir, exist_ok=True)
    os.makedirs(args.ir_label_out_aug_dir, exist_ok=True)
    os.makedirs(args.sem_seg_out_aug_dir, exist_ok=True)
    #######################修改代码######################
    ...
    # step.make_aug_fg.run(args)

    # import aug_step.train_cam
    # aug_step.train_cam.run(args)

    # import aug_step.make_cam
    # aug_step.make_cam.run(args)

    # import aug_step.eval_cam
    # aug_step.eval_cam.run(args)

    # import aug_step.cam_to_ir_label
    # aug_step.cam_to_ir_label.run(args)

    # import aug_step.train_irn
    # aug_step.train_irn.run(args)

    # import aug_step.make_sem_seg_labels
    # aug_step.make_sem_seg_labels.run(args)

    # import aug_step.eval_sem_seg
    # aug_step.eval_sem_seg.run(args)
